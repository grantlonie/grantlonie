...
export const portfolioItems: PortfolioItemProps[] = [
  {
    ...
    imageUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/bombdoor.gif',
  ...
  },
  {
    ...
    imageUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/designer.gif',
    subtitle: 'Database CRUD management tool',
    videoUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/designer.mp4',
  },
  {
    title: 'Tada Builder',
    description:
    ...
    imageUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/builder.gif',
  ...
  },
  {
    ...
    imageUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/displays.gif',
    subtitle: 'Heavy manufacturing rugged touch screens',
    videoUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/displays.mp4',
  },
  {
    title: 'Electronics',
    description:
    ...
    iconUrl: '/portfolio-icons/ARi.png',
    imageUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/electronics.gif',
    subtitle: 'Electronic hw and embedded applications',
    videoUrl: 'https://storage.cloud.google.com/grantlonie-public/showcase/electronics.mp4',
  },
]
